            ...
            <form action="{{ route('updateproduct') }}" method="POST">
             ...
             <input type="hidden" value="{{ $productinfo->id }}" name="id">
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <textarea class="form-control" id="product_short_des" name="product_short_des" rows="3">{{  $productinfo->product_short_des }}</textarea>

                </div>
              </div>
              <div class="row mb-3">
                <label class="col-sm-2 col-form-label" for="basic-default-name">Product long Descriptione</label>
                <div class="col-sm-10">
                    <textarea class="form-control" id="product_long_des" name="product_long_des" rows="3">{{  $productinfo->product_long_des }} </textarea>
