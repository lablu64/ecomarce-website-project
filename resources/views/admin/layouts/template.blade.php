...
<html
  ...
  data-assets-path="{{ asset('dashborad/assets/') }}"
...
>
  <head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="{{asset('dashborad/assets/img/favicon/favicon.ico')}}" />
    ...
    <link rel="stylesheet" href="{{asset('dashborad/assets/vendor/fonts/boxicons.css')}}" />

    <!-- Core CSS -->
    <link rel="stylesheet" href="{{asset('dashborad/assets/vendor/css/core.css')}}" class="template-customizer-core-css" />
    <link rel="stylesheet" href="{{asset('dashborad/assets/vendor/css/theme-default.css')}}" class="template-customizer-theme-css" />
    <link rel="stylesheet" href="{{asset('dashborad/assets/css/demo.css')}}" />

    <!-- Vendors CSS -->
    <link rel="stylesheet" href="{{asset('dashborad/assets/vendor/libs/perfect-scrollbar/perfect-scrollbar.css')}}" />

    <link rel="stylesheet" href="{{asset('dashborad/assets/vendor/libs/apex-charts/apex-charts.css')}}" />
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="index.html" class="app-brand-link">
              ...
              <span class="app-brand-text demo menu-text fw-bolder ms-2">Ecommarce</span>
            </a>
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-header small text-uppercase">
              ...
              <li class="menu-item ">
                  <a href="{{ route('allpendingoders') }}" class="menu-link">
                    <i class="menu-icon tf-icons bx bx-home-circle"></i>
              ...
              <li class="menu-item ">
                <a href="index.html" class="menu-link">
                  <i class="menu-icon tf-icons bx bx-home-circle"></i>
                  <div data-i18n="Analytics">chencel Orders</div>
                </a>
              </li>
            </li>
          </ul>
